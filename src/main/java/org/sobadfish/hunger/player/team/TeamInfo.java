package org.sobadfish.hunger.player.team;

import cn.nukkit.Server;
import cn.nukkit.level.Position;
import cn.nukkit.level.Sound;
import cn.nukkit.utils.TextFormat;
import org.sobadfish.hunger.event.PlayerChoseTeamEvent;
import org.sobadfish.hunger.event.TeamDefeatEvent;
import org.sobadfish.hunger.event.TeamVictoryEvent;
...
public class TeamInfo {
    ...
    public ArrayList<PlayerInfo> outPlayers = new ArrayList<>();
    ...
    public void echoVictory(PlayerInfo playerInfo){
        //TODO 当队伍胜利
        TeamVictoryEvent event = new TeamVictoryEvent(playerInfo,room, TotalManager.getPlugin());
    ...
    public void echoDefeat(){
        //TODO 当队伍失败
        TeamDefeatEvent event = new TeamDefeatEvent(outPlayers,room,TotalManager.getPlugin());
        Server.getInstance().getPluginManager().callEvent(event);
